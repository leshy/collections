...
(function() {
  var Backbone, Permission, RemoteModel, SaveRealm, Select, Validator, async, collections, definePermissions, helpers, sman, subscriptionman2, v, _;
  ...
  RemoteModel = exports.RemoteModel = Validator.ValidatedModel.extend4000(sman, {
    ...
    applyPermission: function(type, attribute, value, realm, callback) {
      var attributePermissions, checkperm, model, permission, permissions, _ref;
      model = this;
