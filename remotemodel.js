...
(function() {
  var Backbone, Permission, RemoteModel, SaveRealm, Select, Validator, _, async, collections, definePermissions, h, sman, subscriptionman2, v,
    slice = [].slice;
  ...
  RemoteModel = exports.RemoteModel = sman.extend4000({
    ...
    applyPermissions: function(type, attrs, realm, callback, strictPerm) {
      ...
      if (strictPerm) {
        return async.series(h.dictMap(attrs, (function(_this) {
        ...
        return async.series(h.dictMap(attrs, (function(_this) {
          ...
          return callback(void 0, h.dictMap(data, function(x) {
            return x;
          }));
        });
      }
        ...
        if (value instanceof RemoteModel) {
          if (id = value.get('id')) {
            ...
            if (err) {
              ...
              h.cbc(callback, void 0, value.reference(id));
            }
          }
          return void 0;
    ...
    flush: function(cb) {
      if (!this._flush) {
        this._flush = h.wrap.throttle({
          time: 25
        }, (function(_this) {
          return function(cb) {
            return _this.flushnow(cb);
          };
        })(this));
      }
      return this._flush(cb);
    },
          ...
          return _this.exportReferences(changes, function(err, changes) {
            ...
            if (!(id = _this.get('id'))) {
              return _this.collection.create(changes, function(err, data) {
                ...
                h.cbc(callback, err, _this.attributes);
