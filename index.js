...
(function() {
  var Backbone, CachingMixin, EventMixin, ModelMixin, ReferenceMixin, RemoteModel, RequestIdMixin, UnresolvedRemoteModel, helpers, settings, sman, subscriptionman2, _,
    __slice = [].slice;
