...
(function() {
  var Backbone, CachingMixin, Core, EventMixin, LiveModelMixin, LiveRemoteModel, ModelMixin, ReferenceMixin, RemoteModel, RequestIdMixin, UnresolvedRemoteModel, _, h, settings, sman, subscriptionman2,
    slice = [].slice;
      ...
      return this.eventAsync('create', {
        ...
        return function(err, subchanges) {
          ...
          return newModel.update(data, realm, function(err, data) {
            ...
            return newModel.flush(function(err, data) {
              return h.cbc(callback, err, _.extend(subchanges, data));
            });
          });
        };
      })(this));
