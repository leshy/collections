...
(function() {
  var Backbone, CachingMixin, Core, EventMixin, LiveModelMixin, LiveRemoteModel, LiveUnresolvedRemoteModel, ModelMixin, ReferenceMixin, RemoteModel, RequestIdMixin, UnresolvedRemoteModel, _, h, settings, sman, subscriptionman2,
    slice = [].slice;
  ...
  UnresolvedRemoteModel = exports.UnresolvedRemoteModel = Backbone.Model.extend4000({
    ...
    resolve: function(callback) {
      if (this._resolving) {
        return this.once('resolve', (function(_this) {
          return function() {
        ...
        return this.collection.findOne({
          ...
          return function(err, entry) {
            ...
            if (!entry) {
              ...
              modelClass = _this.collection.resolveModel(entry);
              _this.morph(modelClass, _.extend(_this.attributes, entry));
  ...
  ReferenceMixin = exports.ReferenceMixin = Backbone.Model.extend4000({
    ...
    unresolved: function(data) {
      ...
      delete data._c;
      return new this.UnresolvedRemoteModel(_.extend(data, {
        collection: this
      }));
    },
    name: function() {
  ...
  RequestIdMixin = exports.RequestIdMixin = Backbone.Model.extend4000({
    find: function(args, limits, callback, callbackDone) {
      ...
      return this._super('find', args, limits, (function(_this) {
        ...
        return function() {
          return h.cbc(callbackDone, void 0, void 0, uuid);
        };
      })(this));
    },
    findOne: function(args, callback) {
  ...
  CachingMixin = exports.CachingMixin = Backbone.Model.extend4000({
    ...
    addToCache: function(uuid, result, timeout) {
      ...
      this.timeouts[name] = h.wait(timeout, (function(_this) {
        return function() {
    ...
    find: function(args, limits, callback, callbackDone) {
      ...
      if (loadCache = this.cache[uuid]) {
        ...
        h.cbc(callbackDone, void 0, void 0, uuid, loadCache);
        return uuid;
      }
      cache = [];
      fail = false;
  ...
  LiveUnresolvedRemoteModel = UnresolvedRemoteModel.extend4000({
    resolve: function(callback) {
      var liveModel;
      if (liveModel = this.collection.liveModels[this.id]) {
        return _.defer(function() {
          return callback(void 0, liveModel);
        });
      } else {
        return UnresolvedRemoteModel.prototype.resolve.call(this, callback);
      }
    }
  });
