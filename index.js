...
(function(){
  var subscriptionman2, _, h, Validator, Backbone, v, RemoteModel, settings, Core, ModelMixin, RemoteInterfaceMixin, subscriptionMan, EventMixin, UnresolvedRemoteModel, ReferenceMixin, RequestIdMixin, CachingMixin, LiveRemoteModel, LiveModelMixin, slice$ = [].slice;
  ...
  RemoteInterfaceMixin = exports.RemoteInterfaceMixin = Backbone.Model.extend4000({
    initialize: function(){
      var parsePermissions, permissions;
      this.permissions = {};
      ...
      return this.permissions = parsePermissions(permissions);
    },
    ...
    rRemove: function(realm, msg, callback){
      var this$ = this;
      return this.applyPermission(this.permissions.remove, msg, realm, function(err, pattern){
        var queue;
        if (err) {
          return callback(err);
        }
    ...
    rFindOne: function(realm, msg, callback){
      var this$ = this;
      return this.applyPermission(this.permissions.findOne, msg, realm, function(err, pattern){
        return this$.findOne(pattern, function(err, entry){
          if (!entry || err) {
            return callback(err);
          } else {
